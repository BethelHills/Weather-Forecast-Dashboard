...
export default function HomeLight() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#6E85D3] to-[#C38EF0] text-gray-900 px-16 py-12">
      ...
      <div className="flex items-center justify-between mb-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="bg-white/30 px-5 py-3 rounded-xl w-[420px] flex items-center">
            <input
              placeholder="Search the Clouds..."
              className="bg-transparent outline-none w-full text-sm text-gray-900/80"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 text-sm">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-5 rounded-full bg-white/60 flex items-center px-1">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="max-w-xl">
          ...
          <p className="text-gray-900/80 leading-relaxed mb-2">
            At BCodeStack-Clouds, we believe weather should not just be data, it should be clear,
            beautiful, and useful.
          </p>

          <p className="text-gray-900/80 leading-relaxed mb-6">
          ...
          <p className="text-gray-900/80 leading-relaxed mb-10">
